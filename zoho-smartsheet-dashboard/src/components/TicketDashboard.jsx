...
  const currentTicketNumber = unassignedTicketNumbers.length > 0
...
              style={{ flex: 1, textAlign: "center", fontWeight: 900, display: "flex", justifyContent: "center", alignItems: "center", gap: 12 }}
            >
...
                  cursor: "pointer",
                  userSelect: "none",
                  border: currentPage === i + 1 ? "2px solid #007bff" : "2px solid #fff",
